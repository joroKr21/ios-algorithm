...
/**
 * <p>
 *  This implementation of a tabu list uses the {@link org.coinor.opents.ComplexMove}'s <code>attributes()</code>
 *  method to determine the move's identity.
 *  <strong>It is imperative that you add the <code>attributes()</code>
 * and implement {@link org.coinor.opents.ComplexMove} rather than just {@link org.coinor.opents.Move}</strong>.
 * </p>
 * <p>
...
public class ComplexTabuList implements TabuList
{
    ...
    * The value 2 will be used as the number of attributes if
    ...
    /**
     * Determines if the {@link org.coinor.opents.ComplexMove} is on the tabu list and ignores the
     * {@link org.coinor.opents.Solution} that is passed to it. The move's identity is determined
     ...
     * @throw IllegalArgumentException if move is not of type {@link org.coinor.opents.ComplexMove}
     * @throw IllegalArgumentException if move's <tt>attributes()</tt> method
     *        returns the wrong number of elements in the array.
     * @see org.coinor.opents.Move
     * @see org.coinor.opents.ComplexMove
     * @see org.coinor.opents.Solution
     * @since 1.0-exp3
     */
    ...
    /**
     * This method accepts a {@link org.coinor.opents.ComplexMove} and {@link org.coinor.opents.Solution} as
     ...
     *
     * Records a {@link org.coinor.opents.ComplexMove} on the tabu list by calling the move's
     * <code>attributes()</code> method.
     *
     * @param move The {@link org.coinor.opents.ComplexMove} to register
     * @param solution The {@link org.coinor.opents.Solution} before the move operation - ignored.
     * @throw IllegalArgumentException if move is not of type {@link org.coinor.opents.ComplexMove}
     * @throw IllegalArgumentException if move's <tt>attributes()</tt> method
     *        returns the wrong number of elements in the array.
     * @see org.coinor.opents.Move
