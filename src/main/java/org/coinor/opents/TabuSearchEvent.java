...
/**
 * These events are fired off by the {@link org.coinor.opents.TabuSearch} and are useful
...
public class TabuSearchEvent extends java.util.EventObject
{
    ...
    /**
     * Casts the <tt>source</tt> as a {@link org.coinor.opents.TabuSearch}
     * prior to returning. It is equivalent to
     * <code>(TabuSearch) getSource()</code>.
     *
     * @return source as {@link org.coinor.opents.TabuSearch}
     * @since 1.0
     */
