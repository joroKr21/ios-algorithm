 ...
 * method so that the {@link org.coinor.opents.SolutionAdapter}'s
 * {@link org.coinor.opents.SolutionAdapter#clone clone()} method is also called.
...
implements Solution
{
     ...
     * indicate that the {@link org.coinor.opents.TabuSearch} has not yet
    ...
    /**
     * Generally used by the {@link org.coinor.opents.TabuSearch} to set the value of the
     * objective function
    ...
    {   try
        ...
        catch( CloneNotSupportedException e ) // Catch exception from java.lang.Object
