...
/**
 * This version of the {@link org.coinor.opents.TabuSearch} can create multiple threads to take advantage
 * of multiple processors. If more than one thread is requested, then the neighborhood
 * will be split up evenly after the {@link org.coinor.opents.MoveManager#getAllMoves getAllMoves()} method is called
 * on your {@link org.coinor.opents.MoveManager}.
 * <p/>
 * <em><b>This is the recommended {@link org.coinor.opents.TabuSearch}</b></em> for nearly all well-threaded
 ...
 * If you add iterations with {@link org.coinor.opents.SingleThreadedTabuSearch#setIterationsToGo setIterationsToGo()} and call
...
/* ********  C O N S T R U C T O R S  ******** */
     ...
     * @see org.coinor.opents.TabuList
     * @see org.coinor.opents.AspirationCriteria
     *
     * @since 1.0
     */
    public MultiThreadedTabuSearch(
    ...
    /**
     * Return the {@link org.coinor.opents.MultiThreadedTabuSearch.NeighborhoodHelper}s being used to search the neighborhood.
     *
     * @since 1.0
     */
