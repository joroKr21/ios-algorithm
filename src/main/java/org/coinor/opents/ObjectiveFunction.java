 ...
 * evaluate a {@link org.coinor.opents.Solution}.
 * 
 *
 *
...
public interface ObjectiveFunction extends java.io.Serializable
{
    ...
    /**
     * The {@link org.coinor.opents.TabuSearch} expects an objective/
     * constraint penalties function to be able
     * to evaluate a solution's worth. The {@link org.coinor.opents.TabuSearch} will
     * pass the <tt>ObjectiveFunction</tt> a {@link org.coinor.opents.Solution} and
     * optionally pass a proposed {@link org.coinor.opents.Move}. If the passed move is
     ...
     * @since 1.0
     */
    public abstract double[] evaluate(Solution soln, Move move);
