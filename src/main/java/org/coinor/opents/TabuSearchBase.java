 ...
 * This abstract class implements {@link org.coinor.opents.TabuSearch} and defines the event-handling methods

 * including the add/remove methods and package-level fireXxx methods.

 * It is the base class for the {@link org.coinor.opents.MultiThreadedTabuSearch} and {@link org.coinor.opents.SingleThreadedTabuSearch}.
...
public abstract class TabuSearchBase implements TabuSearch

{
     ...
     * completed since the instantiation of this {@link org.coinor.opents.TabuSearch}.
     ...
     * of {@link org.coinor.opents.TabuSearchBase} at the end of an iteration.
...
/* ********  E V E N T   C O D E  ******** */
     ...
     * An array of {@link org.coinor.opents.TabuSearchListener}s. An array is
     ...
     * @see org.coinor.opents.TabuSearchListener
...
/* ********  A D D   M E T H O D S  ******** */    
     ...
     * @param listener The {@link org.coinor.opents.TabuSearchListener} to register.
...
/* ********  R E M O V E   M E T H O D S  ******** */
      ...
      * @param listener {@link org.coinor.opents.TabuSearchListener} to remove from notification list.
...
/* ********  F I R E   M E T H O D S  ******** */
     ...
     * The {@link org.coinor.opents.TabuSearchEvent} sent to the listeners is a
