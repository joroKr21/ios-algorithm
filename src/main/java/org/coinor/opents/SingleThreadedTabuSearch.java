...
/**
 * This version of the {@link org.coinor.opents.TabuSearch} does not create any new threads, making it
...
//        2
     ...
     * {@link org.coinor.opents.TabuSearchEvent} should be fired at the end of the iteration.
     *
     ...
     * new current solution {@link org.coinor.opents.TabuSearchEvent}
    ...
    /**
     * Returns whether or not the tabu search plans to fire a
     * new best solution {@link org.coinor.opents.TabuSearchEvent}
     * at the end of the iteration.
     *
     * @return whether or not the tabu search plans to fire a
     ...
     * unimproving move made {@link org.coinor.opents.TabuSearchEvent}
     * at the end of the iteration.
     *
    ...
    /**
     * Returns whether or not the tabu search plans to fire an
     * improving move made {@link org.coinor.opents.TabuSearchEvent}
     * at the end of the iteration.
     *
     * @return whether or not the tabu search plans to fire an
    ...
    /**
     * Returns whether or not the tabu search plans to fire a
     * no change in value move made {@link org.coinor.opents.TabuSearchEvent}
     * at the end of the iteration.
     *
     * @return whether or not the tabu search plans to fire a
...
/* ********  T A B U S E A R C H   M E T H O D S  ******** */    
     ...
     * and fires an event to registered {@link org.coinor.opents.TabuSearchListener}s.
     *
     * @param solution The new best solution.
     * @see org.coinor.opents.Solution
     * @since 1.0
