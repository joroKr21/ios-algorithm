...
/**
 * <p>
 *  This implementation of a tabu list uses the {@link org.coinor.opents.Move}'s <code>hashCode()</code>
...
public class SimpleTabuList implements TabuList
{
    ...
    /**
     * Determines if the {@link org.coinor.opents.Move} is on the tabu list and ignores the
    ...
    /**
     * This method accepts a {@link org.coinor.opents.Move} and {@link org.coinor.opents.Solution} as
     ...
     *
     * Records a {@link org.coinor.opents.Move} on the tabu list by calling the move's
     * <code>hashCode()</code> method. <strong>It's imperative
     * that you override the <code>hashCode()</code> method with one 
     * that identifies the move appropriately for your problem</strong>.
     *
     * @param move The {@link org.coinor.opents.Move} to register
